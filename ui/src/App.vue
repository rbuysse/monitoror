      ...
      <div class="c-app--loading" v-if="shouldShowLoading" :class="appLoadingClasses">
        <div class="c-app--loading-container">
          ...
          <div class="c-app--logo">
            <div class="c-app--logo-slide-in">
              <div class="c-app--logo-slide-welcome">
...
<style lang="scss">
  ...
  .c-app--logo {
    --logo-width: 1500px;
    --logo-scale: 1;
    --logo-translate-y: calc(50vh - 50%);
    --logo-margin: 50px;

    position: absolute;
    top: 0;
    left: var(--logo-margin);
    width: calc(100vw - var(--logo-margin));
    height: 100vh;
    ...
    svg {
      width: 100%;
      transform: translate(calc(50vw - var(--logo-margin) - 50%), calc(50vh - 50%));
  ...
  .c-app__welcome-page {
    ...
    .c-app--logo-slide-welcome {
      animation: logoSlideWelcome 600ms ease 1s;
    }
  }
  ...
  .c-app--loading-errors {
    ...
    animation: fadeIn 300ms both ease 500ms;
  }
